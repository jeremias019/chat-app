...
export declare type MessageResponse<AttachmentType = UnknownType, ChannelType = UnknownType, CommandType extends string = LiteralStringForUnion, MessageType = UnknownType, ReactionType = UnknownType, UserType = UnknownType> = MessageBase<AttachmentType, MessageType, UserType> & {
    args?: string;
    channel?: ChannelResponse<ChannelType, CommandType, UserType>;
    cid?: string;
    command?: string;
    ...
    quoted_message?: Omit<MessageResponse<AttachmentType, ChannelType, CommandType, MessageType, ReactionType, UserType>, 'quoted_message'>;
    reaction_counts?: {
        [key: string]: number;
    } | null;
    reaction_scores?: {
...
export declare type OwnUserResponse<ChannelType extends UnknownType = UnknownType, CommandType extends string = LiteralStringForUnion, UserType extends UnknownType = UnknownType> = UserResponse<UserType> & {
    channel_mutes: ChannelMute<ChannelType, CommandType, UserType>[];
...
export declare type QuerySort<ChannelType = UnknownType, UserType = UnknownType> = BannedUsersSort | ChannelSort<ChannelType> | UserSort<UserType>;
/**
 * Base Types
 */
...
export declare type SearchPayload<AttachmentType = UnknownType, ChannelType = UnknownType, CommandType extends string = LiteralStringForUnion, MessageType = UnknownType, ReactionType = UnknownType, UserType = UnknownType> = SearchOptions & {
    client_id?: string;
    connection_id?: string;
